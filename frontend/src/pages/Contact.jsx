...
const Contact = () => {
  ...
  return (
    <div className="py-24 min-h-screen bg-immersive-dust outline-none relative overflow-hidden">
      ...
      <div className="hidden md:block absolute top-0 left-0 w-64 h-64 border-t-8 border-l-8 border-rajasthan-gold/30 rounded-tl-full opacity-50 transform -translate-x-1/4 -translate-y-1/4 pointer-events-none"></div>
      <div className="hidden md:block absolute bottom-0 right-0 w-64 h-64 border-b-8 border-r-8 border-rajasthan-gold/30 rounded-br-full opacity-50 transform translate-x-1/4 translate-y-1/4 pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl font-royal text-amber-50/90 tracking-wide px-4">Got a question or want to collaborate? Send us a royal decree (or just an email), and we'll get right back to you!</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <motion.div 
            ...
            className="dark-royal-glass p-6 md:p-12 rounded-3xl md:rounded-[40px] border-t-4 border-rajasthan-saffron shadow-3xl relative"
          >
            ...
            <h3 className="text-2xl md:text-4xl font-bold font-ethnic text-rajasthan-gold mb-8 italic">Send a Message</h3>
          ...
          >
            ...
            <div className="dark-royal-glass p-5 md:p-8 rounded-3xl flex items-center gap-4 md:gap-6 border-l-4 border-rajasthan-saffron group hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="min-w-0">
                <h4 className="font-bold text-[10px] md:text-xs tracking-[0.2em] font-royal uppercase text-amber-100/70 mb-1">Email Queries</h4>
                <a href="mailto:rca.svnit@gmail.com" className="text-white text-lg md:text-2xl font-ethnic font-bold hover:text-rajasthan-saffron transition-colors truncate block">rca.svnit@gmail.com</a>
              </div>
            </div>
            
            <div className="dark-royal-glass p-5 md:p-8 rounded-3xl flex items-center gap-4 md:gap-6 border-l-4 border-rajasthan-red group hover:-translate-y-2 transition-transform duration-300">
              <div className="w-14 h-14 md:w-20 md:h-20 bg-rajasthan-red/10 text-rajasthan-red rounded-full flex items-center justify-center border border-rajasthan-red/20 group-hover:bg-rajasthan-red group-hover:text-white transition-colors duration-500 flex-shrink-0">
